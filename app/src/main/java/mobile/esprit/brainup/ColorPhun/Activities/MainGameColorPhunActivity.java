...
public abstract class MainGameColorPhunActivity extends AppCompatActivity {
    ...
    protected void startGame() {
        ...
        Toast.makeText(this, R.string.Colorgame_help, Toast.LENGTH_SHORT).show();
        setColorsOnButtons();
    ...
    private int saveAndGetHighScore() {
        ...
        int highScore = preferences.getInt("HIGHSCORE_COLORPHUN", 0);

        if (points > highScore) {
            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt("HIGHSCORE_COLORPHUN", points);
            editor.apply();
            highScore = points;
        }
        return highScore;
    ...
    private void launchGameOver(int highScore) {
        ...
        Intent intent = new Intent(this, GameOverColorActivity.class);
