...
import mobile.esprit.brainup.ColorPhun.Utilis.BetterColor;
import mobile.esprit.brainup.R;

public class EasyGameColorPhunActivity extends  MainGameColorPhunActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy_game_color_phun);
        setupProgressView();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(EasyGameColorPhunActivity.this, ColorMainActivity.class));
    }
}
